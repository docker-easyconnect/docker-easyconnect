...
另有 [@shmilee](https://github.com/shmilee) 的[方案](https://github.com/shmilee/scripts/tree/master/easyconnect-in-docker)（另见 [#35](https://github.com/Hagb/docker-easyconnect/issues/35)）实现了多 EasyConnect 版本共用容器，另外又包含了一个[纯 cli 版本的 easyconn](https://github.com/Hagb/docker-easyconnect/issues/35#issuecomment-790597107)。
